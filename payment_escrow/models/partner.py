...
class Partner(models.Model):
    ...
    criminal_record_doc = fields.Binary(string='Criminal Record Document', attachment=True)
    criminal_record_doc_filename = fields.Char(string='Criminal Record Document Filename')
    residence_doc = fields.Binary(string='Residence Document', attachment=True)
    residence_doc_filename = fields.Char(string='Residence Document Filename')
