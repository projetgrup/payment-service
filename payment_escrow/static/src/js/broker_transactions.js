...
publicWidget.registry.payloxBrokerTransaction = payloxPage.extend({
    ...
    init: function (parent, options) {
        ...
        this.transactions = {
            uploadInvoice: new fields.element({
                events: [['click', this._onClickUploadInvoice]]
            }),
    ...
    _onClickUploadInvoice: function(ev) {
        ...
        const popup = new dialog(this, {
            ...
            technical: false,
            size: 'small',
            dialogClass: 'o_payment_escrow_upload_invoice',
            $content: qweb.render('paylox.escrow.transaction.uploadInvoice', {
                format,
                currency,
                transferAmount,
                adNumber,
