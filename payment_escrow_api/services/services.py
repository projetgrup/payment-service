...
class EscrowAPIService(Component):
    ...
    def insurance_callback(self, params):
        ...
        try:
            ...
            policy_pdf_base64 = params.policy_pdf if hasattr(params, 'policy_pdf') else None
            ...
            vals = {
                ...
                'policy_pdf_filename': f"policy_{quote.plate}_{getattr(params, 'policy_number', 'N/A')}.pdf",
                'policy_number': getattr(params, 'policy_number', ''),
            ...
            quote.message_post(
                body=_('Insurance sold: %s - Amount: %.2f - Commission: %.2f - Policy: %s') % (
                    ...
                    getattr(params, 'policy_number', 'N/A')
                ),
