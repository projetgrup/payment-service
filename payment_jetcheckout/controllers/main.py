...
class PayloxController(http.Controller):
    ...
    def _process(self, tx=None, **kwargs):
        ...
        try:
            tx.with_context(domain=request.httprequest.referrer)._paylox_query({
                ...
                'code': kwargs.get('response_code', '') or False,
                'message': kwargs.get('response_message', '') or kwargs.get('message', '') or False,
                ...
                'card_program': kwargs.get('card_program', '') or False,
    ...
    def initialize(self, **kwargs):
        ...
        if payment_type == 'virtual_pos':
            ...
            hash = base64.b64encode(hashlib.sha256(''.join([acquirer.jetcheckout_api_key, not verify and token_ref or card_number or '', str(amount_integer), acquirer.jetcheckout_secret_key]).encode('utf-8')).digest()).decode('utf-8')
            data = {
                "application_key": acquirer.jetcheckout_api_key,
                "mode": acquirer._get_paylox_env(),
            ...
            vals = {
                ...
                'jetcheckout_data': kwargs.get('log') and json.dumps({**kwargs}, default=str) or False,
